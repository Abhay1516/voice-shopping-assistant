...
[**Try the Live Demo**](your-firebase-hosting-url-here.web.app)
...
2. Create new project: "voice-shopping-assistant"
3. Enable Firestore Database
4. Enable Firebase Hosting
5. Copy your config and update `firebase-config.js`

### 4. OpenAI Setup (Optional)
1. Get API key from [OpenAI Platform](https://platform.openai.com/)
2. The app will prompt you to enter it when first loaded
